...
export function format_date(value) {
  return moment(value).tz("America/Mexico_City").format("DD/MMM/YY");
}
export function format_date_month(value) {
  return moment(value).tz("America/Mexico_City").format("MMM/YY");
}
export function format_dateUnix(value) {
  return moment.unix(value).tz("America/Mexico_City").format("MMM/DD/YY");
}
export function dateInputLocalFormat(value) {
  return moment(value).tz("America/Mexico_City").format("YYYY-MM-DDTHH:mm");
}
...
export function format_dateHr(value) {
  return moment(value).tz("America/Mexico_City").format("DD/MMM/YY - HH:mm");
}
export function format_hour(value) {
  return moment(value).tz("America/Mexico_City").format("HH:mm");
}
...
export function dateInputFormat(value) {
  return moment(value).tz("America/Mexico_City").format("YYYY-MM-DD");
}
